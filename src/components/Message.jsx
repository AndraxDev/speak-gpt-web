            ...
            { isBot ? (
                <div className={"message-bot"}>
                    ...
                    {!message.toString().includes("~file:") ? <Markdown
                        ...
                        <img id={"image-" + sha256(message)} className={isAssistant ? "chat-image-assistant" : "chat-image"}
                ...
                <div className={"message-user"}>
                    ...
                    <p className={"message-content"}>{message}</p>
                    {
                        image !== null && image !== undefined ?
                            <img id={"image-" + sha256(image.toString())} className={isAssistant ? "chat-image-assistant" : "chat-image"} src={image}/> : null
                    }
                </div>
            )}
        </div>
